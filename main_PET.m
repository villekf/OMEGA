            ...
            for osa_iter = 1 : options.subsets
                ...
                if options.single_reconstructions
                    ...
                    if options.MRP && any(options.OSL_COSEM)
                        ...
                        if options.OSL_COSEM == 1
                            [options.im_vectors.MRP_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.MRP_COSEM_apu, options.D, options.beta_MRP_cosem, med, options.epps, A, uu, ...
                                options.C_osl, options.h, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        else
                            [options.im_vectors.MRP_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.MRP_COSEM_apu, options.D, options.beta_MRP_cosem, med, options.epps, A, uu, ...
                                options.C_osl, 0, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        end
                        if options.verbose
                            tElapsed = toc(tStart);
                    ...
                    if options.L && any(options.OSL_COSEM)
                        ...
                        if options.OSL_COSEM == 1
                            [options.im_vectors.L_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.L_COSEM_apu, options.D, options.beta_L_cosem, med, options.epps, A, uu, options.C_osl, ...
                                options.h, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        else
                            [options.im_vectors.L_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.L_COSEM_apu, options.D, options.beta_L_cosem, med, options.epps, A, uu, options.C_osl, 0, ...
                                options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        end
                        if options.verbose
                            tElapsed = toc(tStart);
                    ...
                    if options.weighted_mean && options.OSL_OSEM
                        ...
                        options.im_vectors.Weighted_OSL_apu = OSEM_im(options.im_vectors.Weighted_OSL_apu, A, options.epps, uu, OSL(Summ, options.beta_weighted_mean_osem, med, options.epps), SinD, ...
                            options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        if options.verbose
                            tElapsed = toc(tStart);
                    ...
                    if options.weighted_mean && options.MBSREM
                        ...
                        options.im_vectors.Weighted_MBSREM_apu = MBSREM(options.im_vectors.Weighted_MBSREM_apu, options.U, options.pj3, A, options.epps, uu, options.epsilon_mramla, ...
                            options.lam_mbsrem, iter, SinD, randoms_correction, options.is_transposed, options.beta_weighted_mean_mbsrem, med, options, ...
                            options.Nx, options.Ny, options.Nz, gaussK);
                        if options.verbose
                            tElapsed = toc(tStart);
                    ...
                    if options.weighted_mean && options.OSL_RBI
                        ...
                        med = Weighted_mean(options.im_vectors.Weighted_RBI_apu, options.tr_offsets, options.weighted_weights, options.Nx, options.Ny, options.Nz, ...
                            options.Ndx, options.Ndy, options.Ndz, options.mean_type, options.epps, options.w_sum, options.med_no_norm);
                        options.im_vectors.Weighted_RBI_apu = RBI_subiter(options.im_vectors.Weighted_RBI_apu, A, uu, options.epps, Summ, options.beta_weighted_mean_rbi, ...
                    ...
                    if options.weighted_mean && any(options.OSL_COSEM)
                        ...
                        med = Weighted_mean(options.im_vectors.Weighted_COSEM_apu, options.tr_offsets, options.weighted_weights, options.Nx, options.Ny, options.Nz, ...
                            options.Ndx, options.Ndy, options.Ndz, options.mean_type, options.epps, options.w_sum, options.med_no_norm);
                        if options.OSL_COSEM == 1
                            [options.im_vectors.Weighted_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.Weighted_COSEM_apu, options.D, options.beta_weighted_mean_cosem, ...
                                med, options.epps, A, uu, options.C_osl, options.h, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, ...
                                options.Nx, options.Ny, options.Nz, gaussK);
                        else
                            [options.im_vectors.Weighted_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.Weighted_COSEM_apu, options.D, options.beta_weighted_mean_cosem, ...
                                med, options.epps, A, uu, options.C_osl, 0, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, ...
                                options.Nx, options.Ny, options.Nz, gaussK);
                        end
                        if options.verbose
                            tElapsed = toc(tStart);
                    ...
                    if options.APLS && any(options.OSL_COSEM)
                        ...
                        if options.OSL_COSEM == 1
                            [options.im_vectors.APLS_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.APLS_COSEM_apu, options.D, options.beta_APLS_cosem, grad, A, uu, ...
                                options.epps, options.C_osl, options.h, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        else
                            [options.im_vectors.APLS_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.APLS_COSEM_apu, options.D, options.beta_APLS_cosem, grad, A, uu, ...
                                options.epps, options.C_osl, 0, options.OSL_COSEM, osa_iter, SinD, options.is_transpose, options, options.Nx, options.Ny, options.Nz, gaussK);
                        end
                        if options.verbose
                            tElapsed = toc(tStart);
                    ...
                    if options.TGV && any(options.OSL_COSEM)
                        ...
                        if options.OSL_COSEM == 1
                            ...
                            [options.im_vectors.TGV_COSEM_apu, options.C_osl] = COSEM_OSL(options.im_vectors.TGV_COSEM_apu, options.D, options.beta_TGV_cosem, grad, A, uu, ...
                                options.epps, options.C_osl, 0, options.OSL_COSEM, osa_iter, SinD, options.is_transposed, options, options.Nx, options.Ny, options.Nz, gaussK);
                        end
                        if options.verbose
                            tElapsed = toc(tStart);
