...
% This example script uses the open preclinical NEMA S6 phantom data from:
% https://zenodo.org/record/4646897
% This differs from the "open PET data" such that the attenuation data is
% obtained from CT measurements. Otherwise everything is identical.
...
options.scatter_correction = true;
...
% options.attenuation_datafile = 'Inveon_attenuation_coefficients_for_NEMA_S6_data_128x128x159.mat';
