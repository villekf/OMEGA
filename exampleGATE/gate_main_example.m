...
%%% optimized and may not work if the GATE simulation time is changed.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
options.beta_fmh_osl = 0.1;
% regularization parameter for weighted mean with OSL
options.beta_weighted_osl = 0.09;
