                    ...
                    if options.projector_type == 1
                        if exist('OCTAVE_VERSION','builtin') == 0
                            [ lor, indices, alkiot] = projector_mex( Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, ...
                                ...
                                randoms_correction, options.scatter, scatter_input, options.global_correction_factor, uint16(0), uint32(0), uint32(0), NSinos, L, pseudot, det_per_ring, false, int64(0), 0, 0, int64(options.TOF_bins), uint32(0), options.verbose, ...
