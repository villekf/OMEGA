__kernel void siddon(__global int* d_indices, __global float*  d_elements, __global ushort* d_lor, __constant int* d_Nx, __constant int* d_Ny, __constant int* d_Nz,
	...
	__global float* d_y, __global float* d_zdet, __constant int *d_size_x, __constant int* d_row, __constant float* d_xxv, __constant float* d_yyv,
	__constant float* d_xxa, __constant float* d_yya, __global int* d_xyindex, __global int* d_zindex, __constant int *d_TotSinos, __constant int *d_attenuation_correction, __global float* d_atten) {
