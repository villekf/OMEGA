    ...
    if options.subsets > 1
        if exist('OCTAVE_VERSION','builtin') == 0
            [A, ~] = projector_mex( options.Ny, options.Nx, options.Nz, options.dx, options.dz, options.by, options.bx, options.bz, options.z_det, options.x, options.y, ...
                ...
                L_input, options.pseudot, options.det_per_ring, false, int64(0), 0, 0, int64(options.TOF_bins), uint32(0), options.verbose, nCores, options.use_raw_data, uint32(0), lor2, options.summa(osa_iter), false, ...
        ...
        if exist('OCTAVE_VERSION','builtin') == 0
            [A, ~] = projector_mex( options.Ny, options.Nx, options.Nz, options.dx, options.dz, options.by, options.bx, options.bz, options.z_det, options.x, options.y, ...
                ...
                options.LL, options.pseudot, options.det_per_ring, false, int64(0), 0, 0, int64(options.TOF_bins), uint32(0), options.verbose, nCores, options.use_raw_data, uint32(0), lor2, options.summa, false, ...
                uint32(options.projector_type), options.tube_width_xy, options.x_center, options.y_center, options.z_center, options.tube_width_z, options.bmin, ...
                options.bmax, options.Vmax, options.V);
        elseif exist('OCTAVE_VERSION','builtin') == 5
            [A, ~] = projector_oct( options.Ny, options.Nx, options.Nz, options.dx, options.dz, options.by, options.bx, options.bz, options.z_det, options.x, options.y, ...
