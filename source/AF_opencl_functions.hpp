...
cl_int createKernels(cl::Kernel& kernelFP, cl::Kernel& kernelBP, cl::Kernel& kernelMBSREM, cl::Kernel& kernelNLM, cl::Kernel& kernelMed,
...
//cl_int createAndWriteBuffers(std::vector<cl::Buffer>& d_x, std::vector<cl::Buffer>& d_z, std::vector<cl::Buffer>& d_lor, std::vector<cl::Buffer>& d_L,
//	std::vector<cl::Buffer>& d_zindex, std::vector<cl::Buffer>& d_xyindex, std::vector<cl::Buffer>& d_Sino, std::vector<cl::Buffer>& d_sc_ra,
//	const std::vector<int64_t>& length, const float* x, const float* z_det, const uint32_t* xy_index, const uint16_t* z_index, const uint16_t* lor1,
//	const uint16_t* L, const float* Sin, cl::Context& af_context, const int64_t* pituus, const float* atten, const float* norm, const float* scat,
...
//	const float* sc_ra, cl::Buffer& d_reko_type, const uint8_t* reko_type, const scalarStruct& inputScalars, cl::Buffer& d_TOFCenter,
//	const float* TOFCenter, const Weighting& w_vec, cl::Image2D& d_maskFP, cl::Image2D& d_maskBP, cl::Image3D& d_uref, const RecMethods& MethodList);
...
cl_int createProgram(const char* k_path, cl::Context& af_context, cl::Device& af_device_id, cl::Program& programFP, cl::Program& programBP,
...
//	const TVdata& data, std::vector<int64_t>& length, std::vector<cl::Buffer>& d_Sino, bool& break_iter, af::array& pj3, const uint32_t n_rekos2, const int64_t* pituus,
