...
if options.weighted_mean && options.BSREM
    ...
    im_vectors.Weighted_BSREM(:,iter_n) = BSREM_iter(im_vectors.Weighted_BSREM_apu, options.lam, iter, options.beta_weighted_bsrem, med, options.epps);
...
if options.weighted_mean && options.ROSEM_MAP
    ...
    im_vectors.Weighted_ROSEM(:,iter_n) = BSREM_iter(im_vectors.Weighted_ROSEM_apu, options.lam_rosem, iter, options.beta_weighted_rosem, med, options.epps);
