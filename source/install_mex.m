    ...
    if (ispc)
        ...
        if use_CUDA
            try
                ...
                mex('-largeArrayDims','-outdir', folder, 'CXXFLAGS="$CXXFLAGS -w"', ['-I ' folder], ['-I"' cuda_path '/include"'], '-lafcuda', '-lcuda', '-lnvrtc', ...
                    ['-L"' af_path '/lib64"'], ['-L"' af_path '/lib"'], ['-L"' cuda_path '/lib64"'], ['-I"' af_path '/include"'], [folder '/CUDA_matrixfree.cpp'],...
                    [folder '/functions.cpp'], [folder '/reconstruction_AF_matrixfree_CUDA.cpp'], [folder '/AF_cuda_functions.cpp'], ...
        ...
        try
            mex('-largeArrayDims', '-outdir', folder, compflags, cxxflags, '-lafopencl', '-lOpenCL', ['-L' af_path '/lib64'], ['-L"' af_path '/lib"'], ...
                ...
                ['-I' af_path '/include'], ['-I"' cuda_path '/include"'], ['-I"' opencl_include_path '"'], '-I/opt/AMDAPPSDK-3.0/include', ...
        ...
        try
            mex('-largeArrayDims', '-outdir', folder, '-lafopencl', '-lOpenCL', ['-L' af_path '/lib64'], ['-L"' af_path '/lib"'], ['-L"' cuda_path '/lib64"'], ...
                ['-L"' opencl_lib_path '"'], '-L/opt/amdgpu-pro/lib64', '-L/opt/AMDAPPSDK-3.0/lib/x86_64' ,['-I ' folder], ['-I' af_path '/include'], ...
        ...
        try
            mex('-largeArrayDims', '-outdir', folder, '-lOpenCL', ['-L"' cuda_path '/lib64"'], ['-L"' opencl_lib_path '"'], '-L/opt/AMDAPPSDK-3.0/lib/x86_64', '-L/opt/amdgpu-pro/lib64', ...
                ...
                if use_CUDA
                    try
                        ...
                        mkoctfile('--mex', ['-I ' folder], ['-I"' cuda_path '/include"'], '-lafcuda', '-lcuda', ...
                            '-lnvrtc', ['-L"' af_path '/lib64"'], ['-L"' af_path '/lib"'], ['-L"' cuda_path '/lib/x64"'], ['-I"' af_path '/include"'], [folder '/CUDA_matrixfree.cpp'],...
                        [folder '/functions.cpp'], [folder '/reconstruction_AF_matrixfree_CUDA.cpp'], [folder '/AF_cuda_functions.cpp'], ...
                        [folder '/compute_ML_estimates.cpp'], [folder '/compute_OS_estimates_iter.cpp'], [folder '/compute_OS_estimates_subiter_CUDA.cpp'])
...
%                 compflags = 'COMPFLAGS="$COMPFLAGS -std=c++11"';
                ...
                try
                    ...
                    if isempty(getenv('CUDA_PATH')) && ~isempty(getenv('INTELOCLSDKROOT'))
                        %%%%%%%%%%%%%%%%%%%%%% Implementation 5 %%%%%%%%%%%%%%%%%%%%%%%
                        try
                            mkoctfile('--mex', cxxflags, ['-I' af_path '/include/'], ['-I' opencl_path '/include/'], ['-L' af_path '/lib64/'], ...
                    ...
                    elseif ~isempty(getenv('OCL_ROOT'))
                        ...
                        try
                            mkoctfile('--mex', cxxflags, '-lafopencl', '-lOpenCL', ['-L' af_path '\lib64'], ['-L' af_path '\lib'],['-I ' folder], ['-I' af_path '\include'], ...
                                [folder '/improved_Siddon_openCL.cpp'])
                            movefile('improved_Siddon_openCL.mex', [folder '/improved_Siddon_openCL.mex'],'f');
                        end
                        ...
                        mkoctfile('--mex', '-lafopencl', '-lOpenCL', ['-L' af_path '\lib64'], ['-L' af_path '\lib'],['-I ' folder], ['-I' af_path '\include'], ...
...
%         cxxflags = 'CXXFLAGS="$CXXFLAGS -DOPENCL"';
        try
            mkoctfile('--mex', '-lafopencl', '-lOpenCL', ['-L' af_path '/lib64'], ['-L' af_path '/lib'], ['-L"' cuda_path '/lib64"'], ['-L"' opencl_lib_path '"'], ...
                '-L/opt/AMDAPPSDK-3.0/lib/x86_64' , '-L/opt/amdgpu-pro/lib64',['-I ' folder], ['-I' af_path '/include'], ['-I"' cuda_path '/include"'], ['-I"' opencl_include_path '"'], ...
        ...
        try
            mkoctfile('--mex', '-lafopencl', '-lOpenCL', ['-L' af_path '/lib64'], ['-L"' af_path '/lib"'], ['-L' cuda_path '/lib64'], ['-L"' opencl_lib_path '"'], ...
                '-L/opt/amdgpu-pro/lib64', '-L/opt/AMDAPPSDK-3.0/lib/x86_64' ,['-I ' folder], ['-I' af_path '/include'], ['-I"' cuda_path '/include"'], ['-I"' opencl_include_path '"'], ...
        ...
        try
            mkoctfile('--mex', '-lOpenCL', ['-L"' cuda_path '/lib64"'], ['-L"' opencl_lib_path '"'], '-L/opt/AMDAPPSDK-3.0/lib/x86_64', '-L/opt/amdgpu-pro/lib64', ...
                ['-I"' cuda_path '/include"'], ['-I"' opencl_include_path '"'], '-I/opt/AMDAPPSDK-3.0/include', [folder '/OpenCL_device_info.cpp'],[folder '/opencl_error.cpp'])
