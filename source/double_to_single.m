...
options.RBI_OSL = logical(options.RBI_OSL);
...
options.COSEM_OSL = uint32(options.COSEM_OSL);
options.mean_type = int32(options.mean_type);
options.beta_huber_osem = single(options.beta_huber_osem);
options.beta_huber_mlem = single(options.beta_huber_mlem);
options.beta_huber_bsrem = single(options.beta_huber_bsrem);
options.beta_huber_mbsrem = single(options.beta_huber_mbsrem);
options.beta_huber_rosem = single(options.beta_huber_rosem);
options.beta_huber_rbi = single(options.beta_huber_rbi);
options.beta_huber_cosem = single(options.beta_huber_cosem);
...
options.beta_NLM_osem = single(options.beta_NLM_osem);
options.beta_NLM_mlem = single(options.beta_NLM_mlem);
options.beta_NLM_bsrem = single(options.beta_NLM_bsrem);
options.beta_NLM_mbsrem = single(options.beta_NLM_mbsrem);
options.beta_NLM_rosem = single(options.beta_NLM_rosem);
options.beta_NLM_rbi = single(options.beta_NLM_rbi);
options.beta_NLM_cosem = single(options.beta_NLM_cosem);
end
