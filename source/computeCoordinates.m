function [x,y] = computeCoordinates(blocks_per_ring, transaxial_multip,cryst_per_block, diameter, orig_diameter, DOI, cr_p, usePseudo)
...
% starting points
alkupistex = (diameter/2 - DOI);
alkupistey = - ((cryst_per_block_orig)/2 + 0.5) * cr_p - DOI;
