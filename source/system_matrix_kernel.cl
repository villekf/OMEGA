__kernel void siddon(__global int* d_indices, __global double* d_elements, __global ushort* d_lor, __constant int* d_Nx, __constant int* d_Ny, __constant int* d_Nz,
	__constant double* d_dz, __constant double* d_d, __constant double* d_bz, __constant double* d_bx, __constant double* d_by, __constant double* d_bxf,
	__constant double* d_byf, __constant double* d_bzf, __constant double* d_bxb, __constant double* d_byb, __constant double* d_bzb, __constant double* d_maxxx,
	__constant double* d_maxyy, __constant double* d_minxx, __constant double* d_minyy, __constant double* d_zmax, __constant double* d_NSlices, __global double* d_x,
	__global double* d_y, __global double* d_zdet, __constant int *d_size_x, __constant int* d_row, __constant double* d_xxv, __constant double* d_yyv,
	__constant double* d_xxa, __constant double* d_yya, __global int* d_xyindex, __global int* d_zindex, __constant int *d_TotSinos, __constant int *d_attenuation_correction, 
	__global double* d_atten) {
