...
%         if exist('OCTAVE_VERSION','builtin') == 0
            [Summ, rhs] = projector_mexCT( options, Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, zmax, options.vaimennus, ...
                ...
                options.n_rays_transaxial, options.n_rays_axial, dc_z, uint32(options.subsets), double(options.angles), uint32(options.xSize), options.dPitch, ...
                int64(numel(options.angles)));
%         elseif exist('OCTAVE_VERSION','builtin') == 5
%             [Summ, rhs] = projector_octCT( options, Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, zmax, options.vaimennus, ...
%                 norm_input, SinD, koko, attenuation_correction, normalization_correction, randoms_correction,...
%                 options.scatter, scatter_input, options.global_correction_factor, lor_a_input, xy_index_input, z_index_input, NSinos, L_input, pseudot, det_per_ring, ...
%                 TOF, TOFSize, sigma_x, TOFCenter, int64(options.TOF_bins), dec, options.verbose, nCores, ...
%                 (use_raw_data), uint32(1), options.listmode, epps, uu, OSEM_apu, uint32(options.projector_type), no_norm, options.precompute_lor, tyyppi, ...
...
%         if exist('OCTAVE_VERSION','builtin') == 0
            [Summ, rhs] = projector_mex( options, Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, zmax, options.vaimennus, ...
                norm_input, SinD, koko, attenuation_correction, normalization_correction, randoms_correction,...
                options.scatter, scatter_input, options.global_correction_factor, lor_a_input, xy_index_input, z_index_input, NSinos, L_input, pseudot, det_per_ring, ...
                TOF, TOFSize, sigma_x, TOFCenter, int64(options.TOF_bins), dec, options.verbose, nCores, ...
                (use_raw_data), uint32(1), options.listmode, epps, uu, OSEM_apu, uint32(options.projector_type), no_norm, options.precompute_lor, tyyppi, ...
...
%         elseif exist('OCTAVE_VERSION','builtin') == 5
%             [Summ, rhs] = projector_oct( options, Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, zmax, options.vaimennus, ...
%                 norm_input, SinD, koko, attenuation_correction, normalization_correction, randoms_correction,...
%                 options.scatter, scatter_input, options.global_correction_factor, lor_a_input, xy_index_input, z_index_input, NSinos, L_input, pseudot, det_per_ring, ...
%                 TOF, TOFSize, sigma_x, TOFCenter, int64(options.TOF_bins), dec, options.verbose, nCores, ...
%                 (use_raw_data), uint32(1), options.listmode, epps, uu, OSEM_apu, uint32(options.projector_type), no_norm, options.precompute_lor, tyyppi, ...
