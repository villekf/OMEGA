...
if options.projector_type == 1
    if exist('OCTAVE_VERSION','builtin') == 0
        [~, rhs_acosem] = projector_mex( Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, zmax, options.vaimennus, ...
            ...
            (use_raw_data), uint32(1), list_mode_format, epps, uu, OSEM_apu, uint32(options.projector_type), no_norm_acosem, options.precompute_lor, true, ...
...
elseif options.projector_type == 2
    if exist('OCTAVE_VERSION','builtin') == 0
        [~, rhs_acosem] = projector_mex( Ny, Nx, Nz, dx, dz, by, bx, bz, z_det, x, y, dy, yy, xx , NSinos, NSlices, size_x, zmax, options.vaimennus, ...
            ...
            options.global_correction_factor, lor_a_input, xy_index_input, z_index_input, NSinos, L_input, pseudot, det_per_ring, ...
            TOF, TOFSize, sigma_x, TOFCenter, int64(options.TOF_bins), dec, options.verbose, nCores, ...
            (use_raw_data), uint32(1), list_mode_format, epps, uu, OSEM_apu, uint32(options.projector_type), no_norm_acosem, options.precompute_lor, true, options.tube_width_xy, ...
