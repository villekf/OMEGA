...
__kernel void siddon(__global float* d_rhs, __global float* d_Summ, __global ushort* d_lor, __constant int* d_Nx, __constant int* d_Ny, __constant int* d_Nz,
	...
	__constant float* d_xxa, __constant float* d_yya, __global ushort* d_L, __constant int* d_det_per_ring, __constant int* d_TotSinos, __constant int* d_attenuation_correction,
	__global float* d_atten, __global float* d_osem, __global float* d_Sino, __constant float* d_epps, __constant int* d_N, __constant int* d_pseudos, __constant int* d_pRows) {
