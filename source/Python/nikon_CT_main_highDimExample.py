# -*- coding: utf-8 -*-
"""
# Python codes for CT reconstruction using Nikon µCT projection images
...
### Source horizontal (row) offset (mm)
...
options.fpath = '/path/to/TS-jyvat.xtekct'


loadNikonData(options)
...
options.Nx = int(950 * 3)

### Y/column-direction
options.Ny = int(950 * 3)

### Z-direction (number of slices) (axial)
options.Nz = int(950 * 3)
...
# effect" in certain slices, i.e. the voxel values are incorrectly scaled.
### Proximal TV
...
plt.pyplot.imshow(pz[:,:,700], vmin=0)