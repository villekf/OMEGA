...
For CUDA/HIP, there are no recommendations on which version to use. This version is pure CuPy, but PyTorch version is available too. For HIP, install the ROCm build of CuPy; HIP is then used automatically.
