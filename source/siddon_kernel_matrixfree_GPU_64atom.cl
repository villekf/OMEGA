...
void siddon(__constant uchar* MethodList, const uchar d_raw, const float d_h, const uint d_Nx, const uint d_Ny, const uint d_Nz,
	...
	const uint d_Nxy, const uint d_det_per_ring, const uint n_rekos, __global ulong* d_Summ, const __global ushort* d_lor, const __global uint* d_xyindex,
