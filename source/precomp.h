...
typedef struct structForScalars {
	...
	bool precompute = false, use_psf = false, TOF = false, SPECT = false, PITCH = false, PET = false, meanFP = false, meanBP = false,
		maskFP = false, maskBP = false, orthXY = false, orthZ = false, CT = false;
	cl_float3 d_Scale = { 0.f, 0.f, 0.f, 0.f };
	cl_float3 dSize = { 0.f, 0.f, 0.f, 0.f };
	cl_float2 dSizeBP = { 0.f, 0.f };
	uint8_t raw = 0, fp = 0, listmode = 0;
	uint16_t n_rays = 1, n_rays3D = 1;
	int64_t nBins = 1, nProjections = 0, numelY = 0, numelZ = 0;
