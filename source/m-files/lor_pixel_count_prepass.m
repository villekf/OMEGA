...
if options.use_raw_data
    if isempty(options.machine_name)
        file_string = [folder options.name '_detector_locations_' num2str(options.Nx) 'x' num2str(options.Ny) 'x' num2str(options.Nz) '_FOV' num2str(options.FOVa_x) 'x' num2str(options.FOVa_y) ...
            'x' num2str(options.axial_fov) '_raw_' num2str(options.det_per_ring) 'x' num2str(options.rings) '.mat'];
    else
        file_string = [folder options.machine_name '_detector_locations_' num2str(options.Nx) 'x' num2str(options.Ny) 'x' num2str(options.Nz) '_FOV' num2str(options.FOVa_x) 'x' num2str(options.FOVa_y) ...
            'x' num2str(options.axial_fov) '_raw_' num2str(options.det_per_ring) 'x' num2str(options.rings) '.mat'];
    end
else %% Sinogram data
    if isempty(options.machine_name)
        file_string = [folder options.name '_lor_pixel_count_' num2str(options.Nx) 'x' num2str(options.Ny) 'x' num2str(options.Nz) '_FOV' num2str(options.FOVa_x) 'x' num2str(options.FOVa_y) ...
            'x' num2str(options.axial_fov) '_sino_' num2str(options.Ndist) 'x' ...
            num2str(options.Nang) 'x' num2str(options.TotSinos) '.mat'];
    else
        file_string = [folder options.machine_name '_lor_pixel_count_' num2str(options.Nx) 'x' num2str(options.Ny) 'x' num2str(options.Nz) '_FOV' num2str(options.FOVa_x) 'x' num2str(options.FOVa_y) ...
            'x' num2str(options.axial_fov) '_sino_' num2str(options.Ndist) 'x' ...
            num2str(options.Nang) 'x' num2str(options.TotSinos) '.mat'];
    end
end
