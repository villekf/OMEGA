...
%                         compiler = 'GCC=/usr/bin/g++-9';
    ...
    if implementation == 0 || implementation == 1 || implementation == 4
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Inveon support %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        try
            mex(compiler, '-largeArrayDims', '-outdir', folder, ['-I ' folder], [folder '/inveon_list2matlab.cpp'])
    ...
    if (ispc)
        ...
        if implementation == 0 || implementation == 2
            if use_CUDA
                ...
                try
                    ...
                    mex(compiler, complexFlag, '-outdir', folder, '-output', 'CUDA_matrixfree', compflags, cxxflags, '-DMATLAB', '-DCUDA', '-DAF', ['-I' folder], ['-I"' cuda_path '/include"'], '-lafcuda', '-lcuda', '-lnvrtc', ...
                        ['-L"' af_path '/lib64"'], ['-L"' af_path '/lib"'], ['-L"' cuda_path '/lib64"'], ['-I' af_path_include], [folder '/OpenCL_matrixfree.cpp']);

                    mex(compiler, complexFlag, '-outdir', folder, '-output', 'CUDA_matrixfree_uint16', compflags, cxxflags, '-DMATLAB', '-DCUDA', '-DAF', '-DMTYPE', ['-I' folder], ['-I"' cuda_path '/include"'], '-lafcuda', '-lcuda', '-lnvrtc', ...
                        ['-L"' af_path '/lib64"'], ['-L"' af_path '/lib"'], ['-L"' cuda_path '/lib64"'], ['-I' af_path_include], [folder '/OpenCL_matrixfree.cpp']);
        ...
        if implementation == 0 || implementation == 2
            try
                ...
                mex(compiler, complexFlag, '-outdir', folder, compflags, cxxflags, '-DMATLAB', '-DOPENCL', '-DAF', '-lafopencl', cxxlib, ['-L' af_path '/lib64'], ['-L"' af_path '/lib"'], ...
                ...
                mex(compiler, complexFlag, '-outdir', folder, '-output', 'OpenCL_matrixfree_uint16', compflags, cxxflags, '-DMATLAB', '-DOPENCL', '-DAF', '-DMTYPE', '-lafopencl', cxxlib, ['-L' af_path '/lib64'], ['-L"' af_path '/lib"'], ...
                    ['-L"' cuda_path '/lib64"'], ['-L"' opencl_lib_path '"'], '-L/opt/amdgpu-pro/lib64', '-L/opt/AMDAPPSDK-3.0/lib/x86_64', ['-I ' folder], ...
                    ['-I' af_path_include], ['-I"' cuda_path '/include"'], ['-I"' opencl_include_path '"'], '-I/opt/AMDAPPSDK-3.0/include', ...
                    [folder '/OpenCL_matrixfree.cpp'])
                disp('Implementation 2 built')
            ...
            try
                mex(compiler, complexFlag, '-outdir', folder, '-output', 'CPU_matrixfree', ['-L' OMPPath], OMPh, OMPLib, LPLib, ['-I ' folder], compflags, cxxflags, '-DMATLAB', '-DCPU', '-DAF', '-lafcpu', ['-L' af_path '/lib64'], ['-L"' af_path '/lib"'], ...
        ...
        if implementation == 0 || implementation == 3
            ...
            try
                ...
                mex(compiler, complexFlag, '-outdir', folder, cxxflags, '-DMATLAB', '-DOPENCL', cxxlib, ['-L"' cuda_path '/lib64"'], ['-L"' opencl_lib_path '"'], '-L/opt/AMDAPPSDK-3.0/lib/x86_64', '-L/opt/amdgpu-pro/lib64', ...
...
%        end
    ...
    if (ispc)
        ...
        %         end
        try
            mkoctfile('--mex', '-v', cxxflags, '-lafopencl', ['-L' af_path '/lib64'], ['-L' af_path '/lib'], ['-L' cuda_path '/lib64'], ['-L' opencl_lib_path], ...
            ...
            mkoctfile('--mex', '-v', '-DMATLAB', '-DAF', '-DOPENCL', cxxflags, '-lOpenCL', '-lafopencl', ['-L' af_path '/lib64'], ['-L' af_path '/lib'], ['-L' cuda_path '/lib64'], ['-L' opencl_lib_path], ...
                '-L/opt/amdgpu-pro/lib64', '-L/opt/AMDAPPSDK-3.0/lib/x86_64', ['-I ' folder], ['-I' af_path_include], ['-I' cuda_path '/include'], ['-I' opencl_include_path], ...
