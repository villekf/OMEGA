        ...
        function obj = projectorClass(options, varargin)
            ...
            if obj.param.implementation == 1
                ...
                if obj.param.use_raw_data
                    ...
                    if isempty(obj.param.machine_name)
                        file_string = [folder obj.param.name '_lor_pixel_count_' num2str(obj.param.Nx) 'x' num2str(obj.param.Ny) 'x' num2str(obj.param.Nz) '_sino_' num2str(obj.param.Ndist) 'x' ...
                            num2str(obj.param.Nang) 'x' num2str(obj.param.TotSinos) '.mat'];
                    else
                        file_string = [folder obj.param.machine_name '_lor_pixel_count_' num2str(obj.param.Nx) 'x' num2str(obj.param.Ny) 'x' num2str(obj.param.Nz) '_sino_' num2str(obj.param.Ndist) 'x' ...
                            num2str(obj.param.Nang) 'x' num2str(obj.param.TotSinos) '.mat'];
                    end
                end
