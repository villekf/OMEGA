...
if options.implementation == 1
    ...
    if options.precompute_lor == false
        if options.use_raw_data == false
            TOFSize = int64(numel(options.index{osa_iter}));
            if options.projector_type == 1 || options.projector_type == 0
                if exist('OCTAVE_VERSION','builtin') == 0 && exist('projector_mex','file') == 3
                    [ lor, indices, alkiot] = projector_mex( options.Ny, options.Nx, options.Nz, options.dx, options.dz, options.by, options.bx, options.bz, options.z_det, ...
                        ...
                        options.TOF, TOFSize, options.sigma_x, options.TOFCenter, int64(options.TOF_bins), options.dec, options.verbose, ...
            ...
            if options.projector_type == 1
                if exist('OCTAVE_VERSION','builtin') == 0
                    [ lor, indices, alkiot] = projector_mex( options.Ny, options.Nx, options.Nz, options.dx, options.dz, options.by, options.bx, options.bz, options.z_det, options.x, ...
                        ...
                        options.TOF, TOFSize, options.sigma_x, options.TOFCenter, int64(options.TOF_bins), options.dec, options.verbose, options.use_raw_data, uint32(2), options.ind_size, options.block1, ...
        ...
        if exist('OCTAVE_VERSION','builtin') == 0
            [A, ~] = projector_mex( options.Ny, options.Nx, options.Nz, options.dx, options.dz, options.by, options.bx, options.bz, options.z_det, options.x, options.y, ...
                ...
                options.TOF, TOFSize, options.sigma_x, options.TOFCenter, int64(options.TOF_bins), options.dec, options.verbose, options.use_raw_data, uint32(0), lor2, options.summa(osa_iter), options.attenuation_phase, ...
    ...
    if options.FMH && options.OSL_OSEM
        ...
        med = FMH(options.im_vectors.FMH_OSL_apu, options.tr_offsets, options.fmh_weights, options.Nx, options.Ny, options.Nz, N, ...
    ...
    if options.FMH && options.MBSREM
        ...
        med = FMH(options.im_vectors.FMH_MBSREM_apu, options.tr_offsets, options.fmh_weights, options.Nx, options.Ny, options.Nz, N, ...
            options.Ndx, options.Ndy, options.Ndz, options.epps, options.med_no_norm);
    ...
    if options.FMH && any(options.COSEM_OSL)
        ...
        med = FMH(options.im_vectors.FMH_COSEM_apu, options.tr_offsets, options.fmh_weights, options.Nx, options.Ny, options.Nz, N, ...
            options.Ndx, options.Ndy, options.Ndz, options.epps, options.med_no_norm);
        if options.COSEM_OSL == 1
    ...
    if options.weighted_mean && options.OSL_OSEM
        ...
        med = Weighted_mean(options.im_vectors.Weighted_OSL_apu, options.weighted_weights, options.Nx, options.Ny, options.Nz, options.Ndx, options.Ndy, options.Ndz, ...
    ...
    if options.weighted_mean && options.MBSREM
        ...
        med = Weighted_mean(options.im_vectors.Weighted_MBSREM_apu, options.weighted_weights, options.Nx, options.Ny, options.Nz, ...
            options.Ndx, options.Ndy, options.Ndz, options.mean_type, options.epps, options.med_no_norm);
    ...
    if options.weighted_mean && any(options.COSEM_OSL)
        ...
        med = Weighted_mean(options.im_vectors.Weighted_COSEM_apu, options.weighted_weights, options.Nx, options.Ny, options.Nz, options.Ndx, options.Ndy, options.Ndz, ...
            options.mean_type, options.epps, options.med_no_norm);
        if options.COSEM_OSL == 1
